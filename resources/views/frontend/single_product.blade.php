...
@endsection
@section('ogurl')
{{ route('SingleProduct', $product->slug) }}
@endsection
@section('ogimage')
                    ...
                    <div class="col-lg-6">
                        <div class="product-single-img">
                            <div class="product-active owl-carousel">
                                ...
                                <div class="item">
                                    <img style="width:500px; height:500px;" src="{{ asset('gallery/'.$gal->created_at->format('Y/m/').$gal->product_id.'/'.$gal->images) }}" alt="text">
                                </div>
                                @endforeach
                            </div>
                            <div class="product-thumbnil-active  owl-carousel">
                                ...
                                @foreach ($gallery as $gal)
                                <div class="item">
                                    <img style="width: 150px; height: 150px;" src="{{ asset('gallery/'.$gal->created_at->format('Y/m/').$gal->product_id.'/'.$gal->images) }}" alt="text">
                                </div>
                                @endforeach
                                {{-- <div class="item">
                        ...
                        <div class="product-single-content">
                            ...
                            <form action="{{ route('addToCart') }}" method="post">
                                ...
                                <input type="hidden" name="product_id" value="{{ $product->id }}">
                                    ...
                                    <ul class="cetagory">
                                        <li>Category : </li>
                                        <li><a href="#">{{ $product->category->category_name}}</a></li><br>
                                        <li>Sub Category : </li>
                                        <li><a href="#">{{ $product->subcategory->subcategory_name }}</a></li><br>
                                    </ul>
                                        <ul class="cetagory">
                                            <li>Color : </li>
                                            <li>
                            ...
                            <ul class="socil-icon">
                                ...
                                <li><a href="https://twitter.com/share?url={{ $product->title }}&url={{ route('SingleProduct', $product->slug) }}"><i class="fa fa-twitter"></i></a></li>
