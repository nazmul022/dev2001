...
<head>
    ...
    <meta property="og:type"  content="@yield('ogwebsite','www.nazmul.dav.com')" />
    <meta property="og:title" content="@yield('ogtitle','This is a title.')" />
    <meta property="og:description" content="@yield('ogdes','hello mark')" />
    <meta property="og:image" content="@yield('ogimage','facebook.com/images')" />
...
<body>
                    ...
                    <div class="col-lg-7 d-none d-lg-block">
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                ...
                                <li class="@yield('blogs')"><a href="{{ route('blogs') }}">Blog</a></li>
    ...
    <script src="{{ asset('abc/woox_travel/about.html') }}"></script>
    @yield('footer_js')
        ...
        <script type="text/javascript">
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/651dd103eb150b3fb99e30b5/1hbu7gudo';
            s1.charset='UTF-8';
