                ...
                <div class="col-lg-4  col-md-6 col-12">
                    <div class="blog-wrap">
                        ...
                        <div class="blog-content">
                            ...
                            <p>{!! Str::limit($item->summary, 200, '...') !!}</p>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="col-12">
                    <div class="pagination-wrapper text-center mb-30">
                        ...
                        <ul class="page-numbers">
                            <li {{ $blogs->currentPage() == 1 ? 'disabled' : '' }}><a class="prev page-numbers" href="{{ $blogs->url(1) }}"><i class="fa fa-arrow-left"></i></a></li>
                            @for ($i = 1; $i <= $blogs->lastPage(); $i++)
                                <li class="rabbi {{ $blogs->currentPage() == $i ? 'current' : '' }}">
                                    <a class="page-numbers" href="{{ $blogs->url($i) }}">{{ $i }}</a>
                                </li>
                            @endfor
                            <li {{ $blogs->currentPage() == $blogs->lastPage() ? 'disabled' : '' }}><a class="next page-numbers" href="{{ $blogs->url($blogs->currentPage() +1) }}"><i class="fa fa-arrow-right"></i></a></li>
                        </ul>
                        @endif
                    </div>
                </div>
