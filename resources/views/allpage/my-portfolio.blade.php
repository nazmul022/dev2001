...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('abc/woox_traveler/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('abc/woox_traveler/assets/css/templatemo-woox-travel.css') }}">
    <link rel="stylesheet" href="{{ asset('abc/woox_traveler/assets/css/owl.css') }}">
    <link rel="stylesheet" href="{{ asset('abc/woox_traveler/assets/css/animate.css') }}">
