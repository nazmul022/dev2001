...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Organic Food</a></div>
        ...
        <div class="sl-sideleft-menu">
            <a href="{{ url('home') }}" class="sl-menu-link @yield('dashboard')">
                ...
                <ul class="sl-menu-sub nav flex-column">
                    ...
                    <li class="nav-item"><a href="{{ url('trashed-category') }}" class="nav-link">Trashed Category</a>
                        {{-- Sub Category --}}
                    <li class="nav-item"><a href="{{ url('subcategory-form') }}" class="nav-link">Add SubCategory</a>
                    <li class="nav-item"><a href="{{ url('subcategory-view') }}" class="nav-link">View SubCategory</a>
                    <li class="nav-item"><a href="{{ url('subcategory-edit') }}" class="nav-link">Edit SubCategory</a>
                    <li class="nav-item"><a href="{{ url('subcategory-update') }}" class="nav-link">Update
                            SubCategory</a>
                    </li>
                ...
                <ul class="sl-menu-sub nav flex-column">
                    {{-- Category --}}
                    <li class="nav-item"><a href="{{ route('blog.create') }}" class="nav-link">Blog Add</a></li>
                    <li class="nav-item"><a href="" class="nav-link">Blog View</a></li>
                    <li class="nav-item"><a href="" class="nav-link">Blog Trashed</a></li>
                        {{-- Sub Category --}}
                    {{-- <li class="nav-item"><a href="{{ url('subcategory-form') }}" class="nav-link">Add SubCategory</a>
                    <li class="nav-item"><a href="{{ url('subcategory-view') }}" class="nav-link">View SubCategory</a>
                    <li class="nav-item"><a href="{{ url('subcategory-edit') }}" class="nav-link">Edit SubCategory</a>
            ...
            <a href="{{ url('users') }}" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-person-stalker tx-20"></i>
                    <span class="menu-item-label">Users</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <a href="{{ url('products') }}" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-person-stalker tx-20"></i>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ url('maya') }}" class="nav-link">Business Page</a></li>
